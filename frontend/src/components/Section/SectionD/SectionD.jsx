...
const SectionD = ({ formData = {}, setFormData, onNext, onBack }) => {
  ...
  const [hasDeptLibrary, setHasDeptLibrary] = useState('no'); // New state for radio button
  ...
  const handleDeptLibraryAvailabilityChange = (e) => {
    setHasDeptLibrary(e.target.value);
  };
  ...
  useEffect(() => {
    setFormData({
      ...formData,
      deptLibrary: hasDeptLibrary === 'yes' ? deptLibraryData : [], // Only include deptLibraryData if "Yes"
      sports: sportsData,
      hostel: hostelData,
      hasDeptLibrary, // Include radio button state
    });
  }, [deptLibraryData, sportsData, hostelData, hasDeptLibrary, setFormData]);
                ...
                <div className="flex items-center space-x-6">
                  <label className="flex items-center">
                    <input
                      ...
                      onChange={handleDeptLibraryAvailabilityChange}
