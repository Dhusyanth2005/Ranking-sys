...
const AuthPage = () => {
  ...
  const initialPage = queryParams.get('page') || 'login'; // Default to 'login' if no query param

  const [currentPage, setCurrentPage] = useState(initialPage); // Initialize based on query param
  ...
  // Update currentPage if query parameter changes
  useEffect(() => {
